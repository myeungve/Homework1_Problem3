...
int main(void)
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		for (int i = 0; i < 5; i++)
		{
			...
			if (InsideCircle(140 + 255 * i, 115, 60, xpos, ypos) == true)
				my_objects[i] = new Change1(140 + 255 * i, 685, 60);
		}
		for (int i = 5, j = 0; i < 10, j < 5; i++, j++)
		{
			...
			// Change color when cursor is inside
			if (InsideCircle(140 + 255 * j, 268, 60, xpos, ypos) == true)
				my_objects[i] = new Change2(140 + 255 * j, 532, 60);
		}
		for (int i = 10, j = 0; i < 15, j < 5; i++, j++)
		{
			...
			// Change color when cursor is inside
			if (InsideCircle(140 + 255 * j, 445, 60, xpos, ypos) == true)
				my_objects[i] = new Change3(140 + 255 * j, 355, 60);
		}
		for (int i = 15, j = 0; i < 20, j < 5; i++, j++)
		{
			...
			// Change color when cursor is inside
			if (InsideCircle(140 + 255 * j, 613, 60, xpos, ypos) == true)
				my_objects[i] = new Change4(140 + 255 * j, 187, 60);
		}
